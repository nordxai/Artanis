...
class MethodNotAllowed(ArtanisException):
    ...
    def __init__(self, path: str, method: str, allowed_methods: Optional[list] = None) -> None:
        details = {
            "path": path,
            "method": method
        }
...
class AuthenticationError(ArtanisException):
    ...
    def __init__(self, message: str = "Authentication required", auth_type: Optional[str] = None) -> None:
        details = {}
